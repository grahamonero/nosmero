// Vendored @noble/ciphers@0.5.3/chacha — self-contained ESM bundle (esbuild, no external imports).
// Used by js/auth/nip49.js for NIP-49 XChaCha20-Poly1305, served locally instead of from a CDN. Byte-
// identical to the npm package (verified). Regenerate: esbuild an entry that re-exports
// { xchacha20poly1305 } from "@noble/ciphers@0.5.3/chacha" --bundle --format=esm.
