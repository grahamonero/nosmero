...
export async function logout() {
    ...
    // Clear the cross-call notification accumulator so the next user's
    // session doesn't see this user's events when their fetches arrive.
    try {
        const Messages = await import('./messages.js');
        Messages.clearAccumulatedNotifications?.();
    } catch (_) {}
