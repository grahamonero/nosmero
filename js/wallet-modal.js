...
async function renderDashboard() {
    ...
    getContentEl().innerHTML = `
        ...
        <div style="background: #1a1a1a; border-radius: 8px; padding: 12px 14px; display: flex; align-items: center; gap: 12px; margin-bottom: 12px;">
            ...
            <button onclick="window.WalletModal.syncWallet()" style="background: #FF6600; border: none; color: #000; padding: 10px 14px; border-radius: 6px; cursor: pointer; font-size: 13px; font-weight: 600; white-space: nowrap;">↻ Sync Now</button>
        </div>
